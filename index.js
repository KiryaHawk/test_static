...
function updateShareHighlightColors(objectManager) {
    ...
    const shareOn = showRegionsOnly; // тот же флаг, что и у кнопки "Доли"
    ...
    objectManager.objects.each(function (obj) {
        ...
        if (shareOn && isHighlighted) {
            // "Доли" включены и точка была подсвечена в Excel — делаем оранжевой
            objectManager.objects.setObjectOptions(objectId, {
                preset: preset,
                iconColor: '#ff9900'
            });
        } else {
            // иначе — стандартный вид
            objectManager.objects.setObjectOptions(objectId, {
                preset: preset,
                iconColor: null
            });

...
function init() {
    fetch('VIP.json')
        ...
        .then(obj => {
            ...
            // Подключаем HTML-кнопку "Доли" (правый нижний угол)
            ...
            if (shareToggle) {
                shareToggle.addEventListener('click', () => {
                    ...
                    // визуально подсвечиваем активное состояние + включаем/выключаем shares-metrics
                    if (showRegionsOnly) {
            ...
            // Фильтры по ДК / категориям / ГИБДД
